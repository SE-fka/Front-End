...
const baseurl = FBAPI.getCommenURL();


const Dashboard_Serch = () => {
...
const getSearchData = (e) => {
    try {
      axios.get(baseurl + `common/insights?startDate=${startdate}&endDate=${enddate}`, {
        headers: AuthHeader()
      }).then((response) => {
...
export default Dashboard_Serch;