...
const FacebookPageDataTable = ({ data }) => {
          ...
          <TableBody>
            {paginatedData.map((row, index) => (
              <TableRow key={index}>
                ...
                <TableCell onClick={() => window.open(`${row.postId}`, "_blank")} style={{color: 'blue'}} sx={{ fontSize: 15 }}>View on Facebook</TableCell>
              </TableRow>
            ))}
          </TableBody>
        </Table>
